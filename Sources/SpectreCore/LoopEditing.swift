...
public enum LoopEdge { case start, end }
...
public enum LoopEditing {
    ...
    public static let minimumLength = 0.05
    ...
    public static func made(from a: Double, to b: Double, duration: Double,
    ...
    public static func moved(_ loop: ClosedRange<Double>, startingAt time: Double,
    ...
    public static func resized(_ loop: ClosedRange<Double>, edge: LoopEdge, to time: Double,
                        duration: Double, snap: (Double) -> Double) -> ClosedRange<Double> {
